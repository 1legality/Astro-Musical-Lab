...
- Son clave (3‑2) mapped to 16th‑note grid
  <StepSequencer16 title="Son Clave (3‑2) • steps 1,4,7,11,13" steps={[1,4,7,11,13]} note={36} bpm={110} />

- Rumba clave (3‑2) mapped to 16th‑note grid
  <StepSequencer16 title="Rumba Clave (3‑2) • steps 1,4,8,11,13" steps={[1,4,8,11,13]} note={36} bpm={110} />

- Tresillo across one bar (repeats each half‑bar)
  <StepSequencer16 title="Tresillo • steps 1,4,7,9,12,15" steps={[1,4,7,9,12,15]} note={36} bpm={110} />
